...
Your project will be graded on a **rubric** covering:

- **HTML Structure**: Semantic elements, validity, proper setup
- **CSS Styling**: Custom styles, color/font consistency, visual design
- **Responsive Design**: Works on mobile, tablet, desktop
- **JavaScript & Forms**: Form validation, interactivity, functionality
- **Content & Media**: Images, table, meaningful content
- **SEO & Accessibility**: Meta tags, heading hierarchy, color contrast, keyboard nav
- **Deployment & Testing**: Live on GitHub Pages, validated, tested

See **html14_Rubric.md** for the detailed criteria.
