...
### Publishing Workflow (GitHub Desktop — what we actually use)
1. Save your changes in VS Code
2. Open GitHub Desktop — your changed files are listed
3. Write a short summary of what changed
4. Commit to main
5. Push origin

*(You may see `git init` / `git add` / `git commit` / `git push` terminal commands online — that's the command-line version of the same four steps. Not tested, not our workflow.)*
...
- Deploy via GitHub Desktop (commit, then push)
...
6. What does git do?
7. What are the four moves of the publish workflow (change, review, commit, push)?
