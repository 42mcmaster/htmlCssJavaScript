...
In GitHub Desktop: **File > Clone repository**, choose `username.github.io`, and pick where to put it on your computer.
...
### Step 4: Commit Your Files (GitHub Desktop)

Open GitHub Desktop. Your added files appear in the Changes list. Write a short, descriptive summary and click **Commit to main**.

### Try This
What summary did you write for the commit? (Something descriptive)
...
### Key Takeaway
You just deployed a real website to the real internet with a commit and a push! This is how modern web developers work.
...
- [ ] I understand the commit-then-push workflow (and what it's doing underneath)
