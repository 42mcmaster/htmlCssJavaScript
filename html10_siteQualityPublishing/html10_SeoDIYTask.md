...
| Criterion | Evidence |
|-----------|----------|
| **SEO Audit Completeness** | Found and documented 10+ SEO issues |
| **Accessibility Audit Completeness** | Found and documented 10+ accessibility issues |
| **SEO Fixes** | Fixed 8+ priority SEO issues correctly |
| **Accessibility Fixes** | Fixed 8+ priority accessibility issues correctly |
| **Documentation Quality** | Clear audit report with before/after examples |
| **Testing & Verification** | Evidence of keyboard navigation and contrast testing |
