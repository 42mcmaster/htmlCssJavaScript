...
## The Four Moves (GitHub Desktop)
1. **Change files** — save your work in VS Code
2. **Review changes** — GitHub Desktop lists what changed
3. **Commit** — write a summary, snapshot the work
4. **Push** — upload the snapshot to GitHub

*(The terminal commands you'll see online — git add / commit / push — are the same moves without the buttons.)*
...
4. **Commit and Push** in GitHub Desktop → Upload to GitHub
