...
5. Explain why hover effects belong to CSS (`:hover`), not JavaScript
6. Build interactive page elements (dark mode toggle, mobile nav; accordions are an extension task)
