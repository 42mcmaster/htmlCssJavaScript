...
## Part 5: Hover Effects — Use CSS, Not JavaScript

Earlier versions of this lesson built hover effects with JavaScript mouseover events. **Don’t.** The correct tool for a hover effect is the CSS `:hover` pseudo-class you learned in html06 — it is simpler, faster, works without JS, and it is what competency 6.2.7 expects:
...
JavaScript event listeners are for things CSS cannot do: responding to clicks, reading input, changing content. Save them for that.
